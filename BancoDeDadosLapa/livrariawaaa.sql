...
-- LIVRO.Titulo_Livro, LIVRO_AUTOR.*, AUTOR.Nome_Autor, EDITORA.Nome_Editora , TIPO_LIVRO.Descricao_Tipo_Livro from LIVRO
...
select LIVRO.Titulo_Livro,
 ...
 TIPO_LIVRO.Descricao_Tipo_Livro 
 from LIVRO
inner join LIVRO_AUTOR on LIVRO.Id_Livro = Livro_Autor.Livro_Id
inner join AUTOR on LIVRO_AUTOR.Autor_Id = Autor.Id_Autor
inner join EDITORA on LIVRO.Editora_Id = Editora.Id_Editora
inner join TIPO_LIVRO on LIVRO.Tipo_Livro_Id = Tipo_Livro.Id_Tipo_Livro;
